...
class FlxRandom
{
	 ...
	 * wanted a 30.5% chance of getting true, call bool(30.5)
	 *
	 * @param   successChance  The chance of getting true
	 */
	@:deprecated("FlxG.random.bool is deprecated, use percent(50) or chance(0.5), instead")
	public inline function bool(successChance = 50.0):Bool
	{
		return percent(successChance);
	}
	 ...
	 * @param   successChance  The chance of getting true
	 */
	public inline function percent(successChance = 50.0):Bool
	{
	 ...
	 * @param   successChance  The chance of getting true
	 */
	public inline function chance(successChance = 0.5):Bool
	{
	 ...
	 * getting a positive value, call sign(30.5)
	 *
	 * @param   successChance  The chance of getting a positive value
	 */
	@:deprecated("FlxG.random.bool is deprecated, use signPercent(50) or signChance(0.5), instead")
	public inline function sign(successChance = 50.0):Int
	{
	 ...
	 * @param   successChance  The chance of getting a positive value
	 */
	public inline function signPercent(successChance = 50.0):Int
	{
		return percent(successChance) ? 1 : -1;
	}
	 ...
	 * @return  1 or -1
	 */
	public inline function signChance(successChance = 0.5):Int
	{
