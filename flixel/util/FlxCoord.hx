...
class FlxCoord
{
	...
	**/
	static public function convertWindowToWorld(windowPos:FlxPoint, ?camera:FlxCamera)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param camera   The camera from which to transform window coordinates. If null, `FlxG.camera` is used.
	**/
	static public function windowToWorldXY(windowX:Float, windowY:Float, ?camera:FlxCamera, ?result:FlxPoint)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param camera   The camera from which to transform window coordinates. If null, `FlxG.camera` is used.
	**/
	static public function cameraToWorldXY(cameraX:Float, cameraY:Float, ?camera:FlxCamera, ?result:FlxPoint)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param camera    The camera from which to transform window coordinates. If null, `FlxG.camera` is used.
	**/
	static public function convertWorldToWindow(worldPos:FlxPoint, ?camera:FlxCamera)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param camera  The camera from which to transform world's coordinates. If null, `FlxG.camera` is used.
	**/
	static public function worldToWindowXY(worldX:Float, worldY:Float, ?camera:FlxCamera, ?result:FlxPoint)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param camera  The camera from which to transform world's coordinates. If null, `FlxG.camera` is used.
	**/
	static public function worldToCameraXY(worldX:Float, worldY:Float, ?camera:FlxCamera, ?result:FlxPoint)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param camera   The camera from which to transform window coordinates. If null, `FlxG.camera` is used.
	**/
	static public function windowToCameraXY(windowX:Float, windowY:Float, ?camera:FlxCamera, ?result:FlxPoint)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param camera   The camera from which to transform world's coordinates. If null, `FlxG.camera` is used.
	**/
	static public function cameraToWindowXY(cameraX:Float, cameraY:Float, ?camera:FlxCamera, ?result:FlxPoint)
	{
		if (camera == null)
			camera = FlxG.camera;
	...
	**/
	 ...
	 * @param toCam    The camera to which to transform world's coordinates.
	**/
	static public function cameraToCameraXY(worldX:Float, worldY:Float, fromCam:FlxCamera, toCam:FlxCamera, ?result:FlxPoint)
	{
		if(result == null)
			result = FlxPoint.get();
